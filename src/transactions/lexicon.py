...
LEXICON: dict = {
    "income": {
        ...
        "incorrect_name": "⛔ Название категории не может быть командой, "
                          "а его длина  не должна превышать 64 символа! Повторите попытку 👇",
    ...
    "edit_income": {
        ...
        "confirm_del_category": "🤔 Вы уверены, что хотите удалить категорию дохода? \n"
                                "❗❗❗ При её удалении удалятся и все доходы, привязанные к ней!",
        "cancel_del_category": "✅ Операция удаления категории дохода отменена!",
        "success_del_category": "✅ Категория дохода успешно удалена!",
        ...
        "confirm_del": "🤔 Вы уверены, что хотите удалить доход?",
        "cancel_del": "✅ Операция удаления дохода отменена!",
        "is_delete": "✅ Доход успешно удалён!"
    },
    "edit_expense": {
        "new_category": "📁 Выберите новую категорию расхода 👇",
        "confirm_del_category": "🤔 Вы уверены, что хотите удалить категорию дохода? \n"
                                "❗❗❗ При её удалении удалятся и все расходы, привязанные к ней!",
        "cancel_del_category": "✅ Операция удаления категории расхода отменена!",
        "success_del_category": "✅ Категория расхода успешно удалена!",
        ...
        "new_card": "💳 Выберите новую карту из списка 👇",
        "card_is_update": "✅ Карта успешно обновлена!",
        "confirm_del": "🤔 Вы уверены, что хотите удалить расход?",
        "cancel_del": "✅ Операция удаления расхода отменена!",
        "is_delete": "✅ Расход успешно удалён!"
    },
    ...
    "in_categories_limit": "⛔ На одном аккаунте не может быть создано более 100 категорий дохода!",
    "ex_categories_limit": "⛔ На одном аккаунте не может быть создано более 100 категорий расхода!",
    ...
    "incorrect_description": "⛔ Описание транзакции не может быть командой, "
                             "а его длина не должна превышать 500 символов! Повторите попытку 👇",
