...
LEXICON: dict = {
    ...
    "income_transactions": {
        ...
        "incorrect_amount": "⛔ Размер дохода должен иметь целочисленный тип данных! Повторите попытку 👇",
    ...
    "expense_transactions": {
        ...
        "expense_is_create": "✅ Доход успешно добавлен!",
        "incorrect_amount": "⛔ Размер расхода должен иметь целочисленный тип данных! Повторите попытку 👇",
