...
CARD_OPERATIONS_LEXICON: dict = {
    ...
    "card_name": {
        ...
        "incorrect_name": "⛔ Название карты не может быть командой, а его длина не должна превышать 64 символа! "
                          "Повторите попытку 👇",
    },
    "update_card_name": {
    ...
    "confirm_del_card": "🤔 Вы уверены, что хотите удалить карту? \n"
                        "❗❗❗ При удалении карты удалятся и все транзакции, привязанные к ней!",
    "cancel_del_card": "✅ Операция удаления отменена!",
    ...
    "error_handling": "⛔ Произошла ошибка! Возможно, клавиатура, которую вы используете, устарела! ⛔\n"
                      "Попробуйте проделать все действия по данному процессу заново, с новой клавиатурой!",
...
LEXICON_COMMANDS: dict = {
    "/cards": {
        ...
        "cards_limit": "⛔ На одном аккаунте не может быть создано более 10 карт!"
    },
